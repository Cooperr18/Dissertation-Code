...
```{r snapshot, fig.align='center', echo=FALSE}
...
```{r time-averaging, fig.align='center', echo=FALSE}
...
```{r neutral snap mu, fig.align='center'}
# import sweep
...
```{r unbiased transmission, fig.align='center'}
